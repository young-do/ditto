...
import { Box, Button, Flex, ModalBody, ModalFooter, ModalHeader, Text, useDisclosure } from '@chakra-ui/react';
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <ModalBody display="flex" flexDirection="column" padding="16px 20px 0px">
        <Flex justifyContent="space-between" alignItems="center" marginBottom="20px">
          ...
          <Switch isChecked={isAllDay} onChange={(e) => setAllDay(e.target.checked)} />
        </Flex>
        ...
        <Flex justifyContent="space-between" alignItems="center" padding="16px 0">
          ...
          <Switch isChecked={isAnnual} onChange={(e) => setAnnual(e.target.checked)} color="#FF541E" />
        </Flex>
